...
train_test_dict = {'train': ['frames_video2_annotations_augmented.json',
                             'frames_video5_annotations_augmented.json',
                             'frames_video6_annotations_augmented.json'],
...
for k in train_test_dict.keys():
    for annot in train_test_dict[k]:
        ...
        label_dir = f"../../data/augmented/labels/{k}"
